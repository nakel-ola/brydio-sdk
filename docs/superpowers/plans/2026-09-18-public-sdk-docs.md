...
- [x] **Step 2: Run the test and observe the missing generator**
...
- [x] **Step 4: Generate the page and pass the focused tests**
...
- [x] **Step 5: Commit the manifest reference**
...
- [x] **Step 1: Extend the bridge test before the generator exists**
...
- [x] **Step 3: Implement the typed exhaustive generator**
...
- [x] **Step 4: Generate the page and pass the focused test**

Run: `bun run docs:bridge && bun test packages/cli/test/bridge-doc.test.ts`

Expected: all tests pass.

- [x] **Step 5: Commit the bridge reference**
...
- [x] **Step 1: Make a focused release-artifact test require a README per package**
...
- [x] **Step 2: Run the test and observe missing package READMEs**

Run: `bun test packages/cli/test/package-docs.test.ts`

Expected: FAIL for packages without `README.md`.

- [x] **Step 3: Add package READMEs and the docs index**
...
- [x] **Step 4: Correct public-state prose**
...
- [x] **Step 5: Pass release and documentation tests**
...
- [x] **Step 6: Commit public-package documentation**
...
- [x] **Step 1: Verify both templates without edits**
...
- [x] **Step 2: Verify the complete SDK**
...
- [x] **Step 3: Re-read the feature line by line**
...
- [x] **Step 4: Update counts and handoff notes**
...
- [x] **Step 5: Append the completion note**
